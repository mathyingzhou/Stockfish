...
#ifdef ATOMIC
    {
      { S(-87,-76), S(-79,-65), S(-36,-40), S( -2,-24), S( 14,  8), S( 23, 25), // Knights
        S( 40, 26), S( 30, 23), S( 37, 29) },
      { S(-55,-65), S(-17,-33), S( 13, -9), S( 24, 20), S( 22, 25), S( 57, 40), // Bishops
        S( 32, 51), S( 66, 67), S( 52, 52), S( 56, 74), S( 74, 75), S( 86, 81),
        S( 92, 89), S(108, 87) },
      { S(-60,-74), S(-32,-28), S(-18,  9), S(-19, 30), S(-19, 57), S( 20, 80), // Rooks
        S( 12,103), S( 11,135), S( 21,133), S( 33,166), S( 35,169), S( 38,186),
        S( 25,171), S( 60,181), S( 58,154) },
      { S(-43,-43), S(-14,-16), S( -5,  1), S(  0, 23), S(  6, 24), S( 23, 58), // Queens
        S( 20, 55), S( 32, 66), S( 47, 89), S( 29, 77), S( 47, 88), S( 69,103),
        S( 64,111), S( 76,131), S( 73,115), S( 47,134), S( 58,132), S( 75,135),
        S( 82,124), S(109,130), S(116,144), S(100,141), S(105,147), S(106,168),
        S(115,156), S(130,177), S(132,175), S(128,209) }
    },
#endif
#ifdef CRAZYHOUSE
    {
...
#ifdef ATOMIC
  constexpr Score ThreatByBlast = S(81, 80);
#endif
