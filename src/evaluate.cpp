...
#ifdef ATOMIC
  Score AtomicThreatByMinor[PIECE_TYPE_NB] = {
    S(0, 0), S(0, 31), S(39, 41), S(57, 43), S(69, 114), S(62, 120)
  };
  Score AtomicThreatByMajor[PIECE_TYPE_NB] = {
...
#ifdef ATOMIC
  Score AtomicThreatByRank = S( 13,  0);
  Score AtomicThreatByPawn = S(176, 94);
#endif
...
#undef S
TUNE(QueenValueMg, KingAttackWeights[ATOMIC_VARIANT], KingDangerParams[ATOMIC_VARIANT],
     MobilityBonus[ATOMIC_VARIANT], PassedRank[ATOMIC_VARIANT], FlankAttacks[ATOMIC_VARIANT]);
TUNE(AtomicThreatByMinor, AtomicThreatByMajor, AtomicThreatByRank, AtomicThreatByPawn);
