...
#ifdef RELAY
  template<PieceType> Bitboard relayed_attacks_from(Square s, Color c) const;
  template<PieceType> Bitboard relayed_attacks_from(Square s, Color c, Bitboard occupied) const;
#endif
