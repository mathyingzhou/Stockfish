...
constexpr Score Bonus[VARIANT_NB][PIECE_TYPE_NB][RANK_NB][int(FILE_NB) / 2] = {
...
#ifdef CRAZYHOUSE
  {
    ...
    { // Pawn
      { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
      { S( -9,  0), S( 29,-22), S( 17, 28), S(-29,  6) },
      { S(-14,-50), S(-24, 14), S( 52, 34), S( 18, 21) },
      { S(-64, 16), S(-57, 13), S( 16, -5), S(-19,-31) },
      { S( 35, 25), S( 11, 14), S( 16,-86), S(113,  5) },
      { S( 27,  7), S(-24,-28), S( 12,-40), S(  9, 32) },
      { S(  8, 51), S( 28,-66), S(-40,-39), S( 65,  2) }
    },
    { // Knight
      { S(-145,-132), S(-269, -59), S(-102,   4), S( -32,-30) },
      { S( -98,-131), S( -47,-132), S( -55,  16), S( -45, 80) },
      { S( -53, -71), S( -59, -26), S(   7,  64), S( -46,-56) },
      { S( -23, -52), S(  88, -33), S(  74,  39), S(  87, 35) },
      { S( 122, -72), S(   0, -96), S(  -9,  63), S( 118,104) },
      { S(  36, -11), S(  47,-125), S(  19, -56), S(  50, 26) },
      { S( -86, -30), S( -31, -25), S( -20, -73), S(  44,-49) },
      { S(-190, -98), S(-132, -77), S( -78, -86), S(  97, 64) }
    },
    { // Bishop
      { S( -9,-64), S(-48,-72), S(-76,-34), S(-21,  9) },
      { S(  8, -9), S( 49, 12), S( 37, -7), S( 28,-23) },
      { S( 34, 15), S( 38,-43), S( 89,-19), S( 50, 28) },
      { S(  3,-33), S( 54,-29), S( 59,-31), S( -4, 53) },
      { S( 27,-34), S( 34,-10), S( 24,-75), S( 13,  9) },
      { S(-15,-55), S(  3,  2), S( -7,-22), S(-50,-26) },
      { S(-33,-34), S( 33, 22), S(-17,-15), S( 15, 33) },
      { S(-35,-23), S(  2,-65), S(-17,-22), S( -3, -4) }
    },
    { // Rook
      { S(-49, 14), S(  4,-33), S( -7, 30), S(-29, 10) },
      { S(-66,  0), S( 18, -2), S( 17,  0), S( 23, 23) },
      { S(-23,-39), S(-51, 13), S( 19,  1), S(  4,  4) },
      { S( -5, 40), S( 15, 26), S(-22,-16), S(-50, 23) },
      { S(-80, 23), S(-54,-29), S(-30, 18), S(  0,-35) },
      { S(  8, 73), S(  8,-19), S( 22, -3), S(  3, 25) },
      { S( 42, 21), S( -8,-20), S(  7, -1), S(  0,-65) },
      { S(-29, 20), S(-22, 11), S(-61,-19), S(-28, 53) }
    },
    { // Queen
      { S( 22,-67), S(  7,-75), S( 13,-54), S( 41,-54) },
      { S( -2,-64), S(  0,-27), S( -3,-17), S( 32,  8) },
      { S( 18,-34), S(  0,-13), S(-22,-59), S(-41,-17) },
      { S( -2,-86), S( -5,  5), S(-17,-41), S(-26,-21) },
      { S(-55,-40), S(-35, 18), S(-37, 20), S(-11, 19) },
      { S(-39,-64), S(  9, 24), S(-32, -7), S(  3, 28) },
      { S( -4,-26), S(-32,-14), S(-19,-82), S(-18,-33) },
      { S(  0,-61), S( 83,-46), S( 37,-68), S( 41, 22) }
    },
    { // King
      { S(364,216), S(470,434), S(198, 63), S( 48, 99) },
      { S(239,125), S(321,122), S(249, 72), S(198,-18) },
      { S(217, 57), S(228, 82), S(270,113), S(149, 75) },
      { S(275,137), S(243,161), S(190,216), S(245,149) },
      { S(162,113), S(221,172), S(156,197), S( 96,261) },
      { S(106,141), S(174,176), S(105,191), S( 91,233) },
      { S(131, 71), S(158,127), S(107,176), S( 30,124) },
      { S(127,-17), S(102, 37), S( 87,107), S( 68,130) }
    }
  },
#endif
#ifdef EXTINCTION
...
constexpr Score inHandBonus[PIECE_TYPE_NB] = {
    S(0, 0), S(52, 13), S(64, 30), S(4, 4), S(13, 3), S(25, 9)
};
#else
