...
enum Value : int {
  ...
  KnightValueMgAtomic = 437,   KnightValueEgAtomic = 643,
  BishopValueMgAtomic = 557,   BishopValueEgAtomic = 716,
  RookValueMgAtomic   = 790,   RookValueEgAtomic   = 1075,
  QueenValueMgAtomic  = 1453,  QueenValueEgAtomic  = 1913,
#endif
#ifdef CRAZYHOUSE
